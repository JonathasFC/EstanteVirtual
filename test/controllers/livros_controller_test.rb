...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post livros_url, params: { livro: { ano_publicacao: @livro.ano_publicacao, edicao: @livro.edicao, genero: @livro.genero, titulo: @livro.titulo } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { ano_publicacao: @livro.ano_publicacao, edicao: @livro.edicao, genero: @livro.genero, titulo: @livro.titulo } }
