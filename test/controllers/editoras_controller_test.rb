...
class EditorasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create editora" do
    assert_difference('Editora.count') do
      post editoras_url, params: { editora: { email: @editora.email, nome: @editora.nome, telefone: @editora.telefone, website: @editora.website } }
    end
  ...
  test "should update editora" do
    patch editora_url(@editora), params: { editora: { email: @editora.email, nome: @editora.nome, telefone: @editora.telefone, website: @editora.website } }
